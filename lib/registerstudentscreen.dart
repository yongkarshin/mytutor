...
void main() => runApp(RegisterStudentScreen());
...
class _RegisterStudentScreenState extends State<RegisterStudentScreen> {
  ...
  String urlRegister = "https://smileylion.com/mytutor/php/register_user.php";
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
              title: Text('Registration Student'),
  ...
  void _registertutor() {
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>RegisterTutorScreen()));
  }
  ...
  void onRegister() {
    ...
    if (phone.length <=9) {
      Toast.show("The length of phone do not less than 11", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    }
    ...
    http.post("https://smileylion.com/mytutor/php/register_user.php", body: {
      ...
      if (res.body == "success") {
        ...
        //Toast.show("Registration succes. An email has been sent to .$email.Please check your email for OTP verification. Also check in your spam folder.", context,
            //duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
        Toast.show("Successful Register",context,duration:Toast.LENGTH_LONG,gravity: Toast.BOTTOM);
      } else if(res.body == "found"){
        Toast.show("This email and phone is registered.", context,
            duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      }
      else {
  ...
  bool validateEmail(String value){
    //Pattern pattern2=r"^[a-zA-Z0-9.a-zA-Z0-9.!#$%&'*+-/=?^_`{|}~]+@[a-zA-Z0-9]+\.[a-zA-Z]+";
